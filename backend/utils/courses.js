...
export const automobile_courses = {
   Automotive_Engines_and_Components: {
    ...
    topics: [
        "Engine Types & Classification",
        "Engine Components: Cylinder, Piston, Crankshaft, Connecting Rod",
        "Valves, Camshaft & Valve Timing Mechanisms",
        "Engine Block & Cylinder Head Design",
        "Fuel Injection Systems (Petrol & Diesel)",
        "Carburetor vs Fuel Injection",
        "Cooling Systems: Air-Cooled & Liquid-Cooled Engines",
        "Lubrication Systems & Oil Pumps",
        "Ignition Systems: Spark Ignition & Compression Ignition",
        "Engine Performance Parameters (BHP, Torque, Efficiency)",
   ...
   Suspension_Steering_and_Braking_Systems: "Suspension, Steering & Braking Systems",
   ...
   Automotive_Safety_and_Crash_Engineering: "Automotive Safety & Crash Engineering",
   ...
   Maintenance_and_Diagnostics_of_Vehicles: "Maintenance & Diagnostics of Vehicles"
}
